        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuestionDe = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    QuestionEn = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    AnswerDe = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionDe = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DescriptionEn = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BeforeImagePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    AfterImagePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageAltDe = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ImageAltEn = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    SlugDe = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueDe = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GalleryItems_DisplayOrder",
                table: "GalleryItems",
                column: "DisplayOrder");
